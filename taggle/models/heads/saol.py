...
class SpatiallyAttentiveOutputHead(nn.Module):
    ...
    def __init__(self, encoder_channels, mid_channel=512, p=0.2, last_activation=None, num_class=10):
        ...
        self.sa_layers = nn.Sequential(
            nn.Conv2d(encoder_channels[0], mid_channel, 3, 1, 1),
    ...
    def forward(self, feats):
        ...
        spatial_attention_map = self.sa_layers(feats[0])
        ...
        feat2 = self.conv2(self.interpolate(feats[1], size=(h, w)))
        feat3 = self.conv3(self.interpolate(feats[2], size=(h, w)))
